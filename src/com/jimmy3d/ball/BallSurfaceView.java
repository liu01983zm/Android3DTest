...
//
        ...
        ball2.drawSelf(gl);//绘制球      
        gl.glPopMatrix();//恢复变换矩阵现场 
        gl.glPushMatrix();//保护变换矩阵现场
        gl.glTranslatef(-10f, 0f, 0f);
        ball3.drawSelf(gl);//绘制球      
        gl.glPopMatrix();//恢复变换矩阵现场 ball3
        
        gl.glPushMatrix();//保护变换矩阵现场
        gl.glTranslatef(0f, 10f, 0f);
        ball4.drawSelf(gl);//绘制球      
        gl.glPopMatrix();//恢复变换矩阵现场 ball4
        gl.glPushMatrix();//保护变换矩阵现场
        gl.glTranslatef(0f, -10f, 0f);
        ball5.drawSelf(gl);//绘制球      
        gl.glPopMatrix();//恢复变换矩阵现场 ball5
        
        gl.glPushMatrix();//保护变换矩阵现场
        gl.glTranslatef(0f, 0f, 10f);
        ball6.drawSelf(gl);//绘制球      
        gl.glPopMatrix();//恢复变换矩阵现场 ball5
        gl.glPushMatrix();//保护变换矩阵现场
        gl.glTranslatef(0f, 0f, -10f);
        ball7.drawSelf(gl);//绘制球      
        gl.glPopMatrix();//恢复变换矩阵现场 ball5
